...
def recipe_shop(recipe) -> str:
    ...
    if "instant pot filipino-style chicken arroz caldo" in haystack:
        ...
        products = [
            ...
            ("8 inch chef knife kitchen", "8-inch chef’s knife", "A sharp all-purpose blade handles pork cubes, cabbage ribbons, mushrooms and sausage with consistent cuts."),
        ]
        ...
        products = [
            ...
            ("8 inch chef knife kitchen", "8-inch chef’s knife", "A sharp controllable blade makes the onion, pepper, cauliflower and garnish prep faster and more even."),
        ...
        products = [
            ...
            ("8 inch chef knife kitchen", "8-inch chef’s knife", "A sharp controllable blade peels and slices ripe mangoes cleanly without crushing their soft flesh."),
        ]
